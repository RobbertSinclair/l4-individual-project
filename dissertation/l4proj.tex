...
\begin{figure}
    \centering
    \includegraphics[width=0.8\linewidth]{images/phase1UIDesign.png}
...
The Runner User Interface (Shown in figure \ref{fig:phase1_ui_runner}) has one key exclusive feature. This is the see Chaser button. If the user
