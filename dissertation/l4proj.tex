...
has a crystal clock which is not as precise than the cesium atomic clocks on the satellites \citep{Rabbanay2006, Kleusberg1990}. While this
form of error is a common cause of problem with GPS accuracy, there isn't a lot of game opportunities due to the fact that the player
...
the signals decrese in quality during a process known as attenuation \citep{Indoors2010}. Some examples of such obstacles include
