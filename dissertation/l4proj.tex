...
\subsection{Treasure}
\emph{Treasure} was a location based game created by \cite{Barkhuus2005}. This was another GPS game which involved
...
\emph{Treasure} shows that lag and latency might not always be considered a bad thing if it is implemented correctly. As a
gameplay it could allow for more interesting and close escapes and it can cause other players to come up with new and creative
strategies.
