...
\begin{itemize}
    ...
    \item \textbf{NEW\_TYPE} This is triggered if either a new user connects to the server or if a user is caught. The server will keep track of whether a player is a runner or a chaser.
    \item \textbf{PLAYER\_CAUGHT} As the name suggests, this will be triggered when the runner has been caught. The server will then move the
\end{itemize}
