...
management will be held on the server and my database. During the course of the game, I will only need two schemas. These
...
The other major job of the server will be to set up a logging system. This will keep track of the player's location, the accuracies
over time and the time when they were a chaser and a runner.  
