...
opportunities to exploit this limitations to gain the upper hand in a GPS based game. One
...
to create a game that exposed differences in WiFi to alter the difficulty of collecting coins.

The ideas of seamful design allow us to play with limitations that we would usually want to fix
and hide. It further gives us the opportunity to push positioning technologies to the limits. It
...
non-existant. My hope is that over the course of playing this game, they will learn what places they should
...
for android phones which has a significant range of phones with different specifications. I wanted to 
see if the differences in specifciatoins would lead to different results of accuracy. To test this I 
asked for the user's phones before starting my user tests and logged both their accuracy and their noise
ratio. This led to the aim of optimizing the game to adjust for different ranges in accuracies.
...
to make a game that people would want to play. I wanted to ensure that there was enough features
to make the game simple to play but hard to master.

\section{Dissertation Outline}
Through the course of this paper, I explore the ideas of seamful design,
...
\begin{itemize}
    ...
    \item Chapter \ref{conclusion} summarises the project and goes over the future work and reflection.
\end{itemize}
...
For instance both Apple and Google state in the privacy terms that they source their location from sources such as WiFi and mobile networks on
...
such as being indoors which can be useful for tracking location history. Another main reason is that sourcing your location entirely from GNSS systems can drain battery life due
...
\emph{Treasure}, a game made by the University of Glasgow, had a coin collection mechanic where the difficulty of collecting
a coin varied on how strong their WiFi signal was. \citep{Barkhuus2005}

\section{Related Products}
\label{relatedproducts}

Over the years there has been several games that utilise GPS coordinates as a fundamental part of the game. In this section I go over various
...
After making the decision to use the LocationManager API, I decided to go to areas outside of the University
campus to get a better idea of what kind of places would be suitable to make a good game. These places were
Buchanan Street in Glasgow city center and Duchess Wood in Helensburgh. I chose Duchess Wood because I wanted
...
found a lot of GPS shadows areas. Especially within buildings such as the Buchanan Gallaries shopping area
and the Argyll Arcade. My visit to the city center made me think that it would be a good idea to allow
...
triggered. During this time the catcher cannot see the runner's latest location or is able to catch a runner. I used
the game portrayed in \emph{Jet Lag: The Game} and the other games described in section \ref{relatedgames} as inspiration \citep{Chase2022}.
...
my server does not have any limits in the number of players, my design has only really had 2 players in mind.
Some ideas of making the game support more players is to turn the game into a last man standing game where
the number of chasers increase as the game goes on. This would make the game more tense as the runners would 
