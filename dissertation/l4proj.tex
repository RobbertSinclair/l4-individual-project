...
clear and simple to use for the duration of the game. Figure \ref{fig:imp_ui} gives
you a view of the two different screens that the player would get when they start a
