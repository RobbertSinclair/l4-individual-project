...
\subsection{GPSMongo.js, GameLogMongo.js and the database}
...
easily get data points within a certain radius. To check whether a runner player was in the catch radius, I just used the query shown in
...
GPSMongo.js is mainly responsible for the functions that keep track of the player's current location during the game. It also puts and reads all of the found
"GPS Shadows" during every game.
