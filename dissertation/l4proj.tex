...
GPS coordinates using 3D mapping and SNR noise ratio to ensure that Uber drivers were more likely to reach their customers. In
the example of a game, seamless design is useful when there are significant balance issues. For example making sure to fix
...
\emph{Can you see me now?} a game made by Blast Theory noted that while they were getting significant error radiuses they
...
\section{New additions in Phase 2}
In response to the evaluations discussed in section \ref{phase1}, I knew that I needed to make some changes to my app
to improve the game based on the user's feedback. This section goes over the four changes that I made during this
iteration of development. 

\subsection{Catching Mechanic}
For this I implemented the phase 2 design that I had discussed in section \ref{phase2catching}

\subsection{Shadow Threshold}

\subsection{Powerup System}
