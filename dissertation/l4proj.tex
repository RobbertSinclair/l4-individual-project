...
take advantage of drops in GPS accuracy to evade capture during their Mixed Reality Game,
...
system that smartphones use. Multiple countries have launched their own satellite positioning systems. For instance, the Samsung Galaxy S21 FE positions itself using the satellites from the Beidou, GALILEO and GLONASS systems as well as GPS. 
\citep{samsungs21specs}. Much like GPS, each one of these GNSS systems has between 24 and 30 satellites \citep{Leick2015}. Therefore, in reality, a phone will be in sight of roughly 15 to 16 satellites rather than the usual 4. This means that phones can
