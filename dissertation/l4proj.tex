...
\begin{itemize}
    ...
    \item \textbf{SYNC\_TIME} Sometimes a phone's timer might be out of sync. This can lead to an unfair disadvantage. The server will therefore have it's own tracker of the game time and will send a message to sync it's time with the other phones.
\end{itemize}
