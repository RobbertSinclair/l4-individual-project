...
class UILocationTextViews : UILocationWidget {
    ...
    constructor(context: Context) {
        ...
        latLabel = activity.findViewById(R.id.latValueLabel);
        longLabel = activity.findViewById(R.id.longValueLabel);
        accuracyLabel = activity.findViewById(R.id.accuracyLabelValue);
        initValues();
    }
